...
The following table shows the average statistics of monsters at various challenge ratings. Actual values can vary considerably from the listed average values. In particular, a monster's actual ability score array can vary greatly from the average depending on its creature type. Similarly, not all monsters carry coinage on their person, but those that do can be expected to carry the amounts shown. Other statistics such as armor class, hit points, and damage per round can also vary considerably, whereas proficiency bonus, attack bonus, and save DC should generally follow the listed values. As usual, follow the guidelines in the *Dungeon Master's Guide* when customizing monsters.
