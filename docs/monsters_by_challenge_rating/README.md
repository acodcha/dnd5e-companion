...
- [CR 0](#challenge-rating-0), [CR ⅛](#challenge-rating-), [CR ¼](#challenge-rating--1), [CR ½](#challenge-rating--2), [CR 1](#challenge-rating-1), [CR 2](#challenge-rating-2), [CR 3](#challenge-rating-3), [CR 4](#challenge-rating-4)
- [CR 5](#challenge-rating-5), [CR 6](#challenge-rating-6), [CR 7](#challenge-rating-7), [CR 8](#challenge-rating-8), [CR 9](#challenge-rating-9), [CR 10](#challenge-rating-10)
- [CR 11](#challenge-rating-11), [CR 12](#challenge-rating-12), [CR 13](#challenge-rating-13), [CR 14](#challenge-rating-14), [CR 15](#challenge-rating-15), [CR 16](#challenge-rating-16)
- [CR 17](#challenge-rating-17), [CR 18](#challenge-rating-18), [CR 19](#challenge-rating-19), [CR 20](#challenge-rating-20), [CR 21](#challenge-rating-21), [CR 22](#challenge-rating-22)
- [CR 23](#challenge-rating-23), [CR 24](#challenge-rating-24), [CR 25](#challenge-rating-25), [CR 26](#challenge-rating-26), [CR 27+](#challenge-rating-27)
...
| CR ½ | Skulk | Med. | Hum. | CN | 100 XP | – | MToF 227 |
...
| CR 1 | Meazel | Med. | Hum. | NE | 200 XP | 4 gp | MToF 214 |
...
| CR 1 | Vargouille (fly) | Tiny | Fiend | CE | 200 XP | – | VGtM 195 |
...
| CR 2 | Kruthik, adult (climb) (burrow) | Med. | Monstr. | – | 450 XP | – | MToF 212 |
...
| CR 2 | Mastiff, shadow | Med. | Monstr. | NE | 450 XP | – | VGtM 190 |
...
| CR 2 | Undying soldier | Med. | Undead | NG | 450 XP | 8 gp | ERftLW 311 |
...
| CR 3 | Karrnathi undead soldier | Med. | Undead | LE | 700 XP | 12 gp | ERftLW 295 |
...
| CR 3 | Mastiff, shadow, alpha | Med. | Monstr. | NE | 700 XP | – | VGtM 190 |
...
| CR 3 | Slithering tracker (climb) (swim) | Med. | Ooze | CE | 700 XP | – | VGtM 191 |
| CR 3 | Spider, phase (climb) | Large | Monstr. | – | 700 XP | – | MM 334 |
| CR 3 | Trapper (climb) | Large | Monstr. | – | 700 XP | – | VGtM 194 |
| CR 3 | Vampire, vampiric mist (fly) | Med. | Undead | CE | 700 XP | – | MToF 246 |
...
| CR 3 | Yugoloth merrenoloth (swim) (spells) | Med. | Fiend | NE | 700 XP | 12 gp | MToF 250 |
...
| CR 4 | Demon, dybbuk (fly) (spells) | Med. | Fiend | CE | 1,100 XP | – | MToF 132 |
...
|  CR   | Name | Size | Type | Align |  XP  | Coins | Source |
| :---: | :--- | :--- | :--- | :---: | ---: | ----: | -----: |
| CR 5 | Allip (fly) | Med. | Undead | NE | 1,800 XP | – | MToF 116 |
...
| CR 5 | Human transmuter (spells) | Med. | Hum. | * | 1,800 XP | 27 gp | VGtM 218 |
...
| CR 5 | Rakshasa zakya (spells) | Med. | Fiend | LE | 1,800 XP | 27 gp | ERftLW 309 |
...
| CR 6 | Devil, abishai, white (fly) | Med. | Fiend | LE | 2,300 XP | 4 pp | MToF 163 |
...
| CR 7 | Demon, armanite | Large | Fiend | CE | 2,900 XP | 6 pp | MToF 131 |
| CR 7 | Demon, maurezhi | Med. | Fiend | CE | 2,900 XP | 6 pp | MToF 133 |
| CR 7 | Devil, abishai, black (fly) | Med. | Fiend | LE | 2,900 XP | 6 pp | MToF 160 |
...
| CR 7 | Shadar-kai shadow dancer | Med. | Hum. | N | 2,900 XP | 6 pp | MToF 225 |
...
| CR 7 | Yugoloth dhergoloth (spells) | Med. | Fiend | NE | 2,900 XP | 6 pp | MToF 248 |
...
| CR 8 | Deathlock mastermind (spells) | Med. | Undead | NE | 3,900 XP | 9 pp | MToF 129 |
...
| CR 9 | Shadar-kai gloom weaver (spells) | Med. | Hum. | N | 5,000 XP | 14 pp | MToF 224 |
...
| CR 9 | Yugoloth hydroloth (swim) (spells) | Med. | Fiend | NE | 5,000 XP | 14 pp | MToF 249 |
...
| CR 10 | Devil, orthon (climb) | Large | Fiend | LE | 5,900 XP | 20 pp | MToF 169 |
...
| CR 10 | Githyanki gish (spells) | Med. | Hum. | LE | 5,900 XP | 20 pp | MToF 205 |
| CR 10 | Githzerai enlightened (spells) | Med. | Hum. | LN | 5,900 XP | 20 pp | MToF 208 |
...
| CR 10 | Undying councilor (spells) (legend) | Med. | Undead | NG | 5,900 XP | 20 pp | ERftLW 311 |
...
|  CR   | Name | Size | Type | Align |  XP  | Coins | Source |
| :---: | :--- | :--- | :--- | :---: | ---: | ----: | -----: |
| CR 11 | Angel, radiant idol (spells) | Large | Celest. | LE | 7,200 XP | 30 pp | ERftLW 308 |
| CR 11 | Balhannoth (climb) (legend) (lair) | Large | Aberr. | CE | 7,200 XP | – | MToF 118 |
...
| CR 11 | Shadar-kai soul monger (spells) | Med. | Hum. | N | 7,200 XP | 30 pp | MToF 226 |
...
| CR 12 | Githyanki kith'rak (spells) | Med. | Hum. | LE | 8,400 XP | 44 pp | MToF 205 |
...
| CR 12 | Ki-rin (fly) (spells) (legend) | Huge | Celest. | LG | 8,400 XP | – | VGtM 163 |
...
| CR 13 | Demon, wastrilith (swim) | Large | Fiend | CE | 10,000 XP | 64 pp | MToF 139 |
...
| CR 14 | Githyanki supreme commander (spells) (legend) | Med. | Hum. | LE | 11,500 XP | 94 pp | MToF 206 |
...
|  CR   | Name | Size | Type | Align |  XP  | Coins | Source |
| :---: | :--- | :--- | :--- | :---: | ---: | ----: | -----: |
| CR 15 | Demon, nabassu (fly) | Med. | Fiend | CE | 13,000 XP | 140 pp | MToF 135 |
| CR 15 | Devil, abishai, green (fly) (spells) | Med. | Fiend | LE | 13,000 XP | 140 pp | MToF 162 |
...
| CR 15 | Rakshasa Mordakhesh (spells) (legend) | Med. | Fiend | LE | 13,000 XP | 140 pp | ERftLW 301 |
...
| CR 16 | Devil, archdevil, Titivilus (fly) (spells) (legend) | Med. | Fiend | LE | 15,000 XP | 200 pp | MToF 179 |
...
| CR 16 | Githzerai anarch (fly) (spells) (legend) (lair) | Med. | Hum. | LN | 15,000 XP | 200 pp | MToF 207 |
...
| CR 17 | Devil, abishai, blue (fly) (spells) | Med. | Fiend | LE | 18,000 XP | 280 pp | MToF 161 |
...
| CR 18 | Demon, sibriex (fly) (spells) (legend) | Huge | Fiend | CE | 20,000 XP | 380 pp | MToF 137 |
| CR 18 | Devil, amnizu (fly) (spells) | Med. | Fiend | LE | 20,000 XP | 380 pp | MToF 164 |
...
| CR 18 | Drow favored consort (spells) | Med. | Hum. | NE | 20,000 XP | 380 pp | MToF 183 |
...
| CR 19 | Devil, abishai, red (fly) | Med. | Fiend | LE | 22,000 XP | 490 pp | MToF 162 |
...
| CR 20 | Nightwalker (fly) | Huge | Undead | CE | 25,000 XP | – | MToF 216 |
...
| CR 22 | Devil, archdevil, Geryon (fly) (spells) (legend) | Huge | Fiend | LE | 41,000 XP | 840 pp | MToF 173 |
...
| CR 23 | Demon, lord, Fraz-urb'luu (fly) (spells) (legend) (lair) | Large | Fiend | CE | 50,000 XP | 930 pp | MToF 146 |
...
| CR 23 | Dragon, shadow, brass, ancient (burrow) (fly) (shapech) (legend) (lair) | Garg. | Dragon | CG | 50,000 XP | – | MM 85, 104 |
| CR 23 | Dragon, shadow, white, ancient (climb) (swim) (fly) (legend) (lair) | Garg. | Dragon | CE | 50,000 XP | – | MM 85, 100 |
| CR 23 | Dragon, silver, ancient (fly) (shapech) (legend) (lair) | Garg. | Dragon | LG | 50,000 XP | – | MM 116 |
| CR 23 | Elder tempest (fly) (legend) | Garg. | Elem. | N | 50,000 XP | – | MToF 200 |
...
|  CR   | Name | Size | Type | Align |  XP  | Coins | Source |
| :---: | :--- | :--- | :--- | :---: | ---: | ----: | -----: |
| CR 26 | Demon, lord, Demogorgon (swim) (spells) (legend) (lair) | Huge | Fiend | CE | 90,000 XP | 1,100 pp | MToF 144 |
| CR 26 | Demon, lord, Orcus (fly) (spells) (legend) (lair) | Huge | Fiend | CE | 90,000 XP | 1,100 pp | MToF 153 |
| CR 26 | Devil, archdevil, Zariel (fly) (spells) (legend) (lair) | Large | Fiend | LE | 90,000 XP | 1,100 pp | MToF 180 |
...
| CR 28 | Overlord, Rak Tulkhesh (climb) (fly) (spells) (shapech) (legend) | Huge | Fiend | NE | 120,000 XP | 1,200 pp | ERftLW 303 |
| CR 28 | Overlord, Sul Khatesh (fly) (spells) (shapech) (legend) | Large | Fiend | LE | 120,000 XP | 1,200 pp | ERftLW 304 |
